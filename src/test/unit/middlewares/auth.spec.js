...
describe('Google Auth Service', () => {
  ...
  it('should throw error when google token is invalid', async () => {
    ...
    await expect(authService.googleAuth('bad_token', 'student')).rejects.toThrow('Invalid Google token')
  })
  ...
  it('should throw error if payload has no email', async () => {
    ...
    await expect(authService.googleAuth('token_without_email', 'student')).rejects.toThrow('Invalid Google token')
  })
